...
# Default: none
CFLAGS  =
mapimage.telestrat: CFLAGS += -D SCREEN_WIDTH=40 -D SCREEN_HEIGHT=26
mapimage.atmos: CFLAGS += -D SCREEN_WIDTH=40 -D SCREEN_HEIGHT=26
mapimage.c64: CFLAGS += -D SCREEN_WIDTH=40 -D SCREEN_HEIGHT=25
